#
# Provider RCP_Embedded_Object_Class
#
require 'syslog'
...
module Cmpi
  ...
  #
  class RCP_Embedded_Object_Class < InstanceProvider
    ...
    def each( context, reference, properties = nil, want_instance = false )
      ...
      result = Cmpi::CMPIObjectPath.new reference.namespace, "RCP_Embedded_Object_Class"
      if want_instance
      ...
      result.InstanceID = "Hello world" # string  (-> RCP_Embedded_Object_Class)
